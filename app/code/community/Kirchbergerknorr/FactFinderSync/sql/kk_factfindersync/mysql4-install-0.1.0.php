...
$installer->addAttribute('catalog_product', 'factfinder_created', $attribute);
...
$installer->addAttribute('catalog_product', 'pim_imported', $attribute);
